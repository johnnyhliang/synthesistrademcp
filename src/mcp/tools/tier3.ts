...
export function registerTier3Tools(server: McpServer, client: SynthesisClient): void {
  ...
  server.tool(
    'place_order',
    'Place a buy or sell order on Polymarket via Polygon. Requires SYNTHESIS_API_KEY and ENABLE_TRADING=true.',
    {
  ...
  server.tool(
    'cancel_order',
    'Cancel an open order on Polygon. Requires SYNTHESIS_API_KEY and ENABLE_TRADING=true.',
    {
  ...
  server.tool(
    'swap',
    'Execute a token swap on Polygon. Requires SYNTHESIS_API_KEY and ENABLE_TRADING=true.',
    {
  ...
  server.tool(
    'withdraw',
    'Withdraw funds from your Synthesis wallet. Requires SYNTHESIS_API_KEY and ENABLE_TRADING=true.',
    {
