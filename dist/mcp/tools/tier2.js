...
export function registerTier2Tools(server, client) {
    ...
    server.tool('reorder_wallets', 'Reorder wallets by position. Pass wallet IDs in desired order. Requires SYNTHESIS_API_KEY.', {
    ...
    server.tool('export_wallet', 'Export a wallet\'s encrypted private key material. WARNING: This exports sensitive cryptographic data. The response contains encrypted key material that can be used to reconstruct the wallet\'s private key. Handle with extreme care. Requires SYNTHESIS_API_KEY.', {
